...
class WeResultException extends \Exception
{
    ...
    private $errorCode = [
        -1      => '系统繁忙，此时请开发者稍候再试' ,
        0       => '请求成功' ,
        40001   => '获取access_token时AppSecret错误，或者access_token无效请开发者认真比对AppSecret的正确性，或查看是否正在为恰当的公众号调用接口' ,
        40002   => '不合法的凭证类型' ,
    ...
    {
        return isset( $this->errorCode[ $this->message ] ) ? $this->errorCode[ $this->message ] : $this->message;
    }
